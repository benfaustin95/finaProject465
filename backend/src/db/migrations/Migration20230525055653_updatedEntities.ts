...
export class Migration20230525055653 extends Migration {
	async up(): Promise<void> {
		...
		this.addSql(
			'alter table "rental_asset" add column "deleted_at" timestamptz(0) null, add column "owner_email" varchar(255) not null, add column "name" varchar(255) not null, add column "maintenance_expense" int not null;'
		);
		this.addSql(
		...
		this.addSql(
			'alter table "financial_asset" add column "deleted_at" timestamptz(0) null, add column "owner_email" varchar(255) not null, add column "name" varchar(255) not null, add column "fin_type" text check ("fin_type" in (\'daily\', \'weekly\', \'monthly\', \'annually\', \'non-reoccurring\')) not null;'
		);
		this.addSql(
		...
		this.addSql(
			'alter table "dividend" add column "deleted_at" timestamptz(0) null, add column "owner_email" varchar(255) not null, add column "name" varchar(255) not null;'
		);
		this.addSql(
		...
		this.addSql(
			'alter table "dividend" add constraint "dividend_asset_id_unique" unique ("asset_id");'
		);

		this.addSql(
			'alter table "cap_asset" add column "deleted_at" timestamptz(0) null, add column "owner_email" varchar(255) not null, add column "name" varchar(255) not null;'
		);
		this.addSql(
		...
		this.addSql(
			'alter table "budget_item" add column "deleted_at" timestamptz(0) null, add column "owner_email" varchar(255) not null, add column "start" timestamptz(0) null, add column "end" timestamptz(0) null;'
		);
		this.addSql(
	...
	async down(): Promise<void> {
		...
		this.addSql(
			'alter table "financial_asset" add column "owner_id" int not null, add column "ira" boolean not null, add column "roth_ira" boolean not null, add column "brokerage" boolean not null;'
		);
		this.addSql(
